...
class MajorNoticeScraper extends BaseNoticeScraper {
  ...
  List<Map<String, String>> fetchHeadlineNotices(document) {
    ...
    for (var headline in headlines) {
      final titleLinkTag = headline.querySelector(HeadlineTagSelectors.kNoticeTitleLink);
      final titleStrongTag = headline.querySelector(HeadlineTagSelectors.kNoticeTitleStrong);
  ...
  List<Map<String, String>> fetchGeneralNotices(document) {
    ...
    for (var general in generals.skip(1)) {
      final titleLinkTag = general.querySelector(GeneralTagSelectors.kNoticeTitleLink);
      final titleStrongTag = general.querySelector(GeneralTagSelectors.kNoticeTitleStrong);
      ...
      if (titleLinkTag == null || titleStrongTag == null || dateTag == null || writerTag == null || accessTag == null) continue;
