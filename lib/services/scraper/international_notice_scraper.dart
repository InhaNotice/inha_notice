...
class InternationalNoticeScraper extends BaseNoticeScraper {
  late final String baseUrl;
  late final String queryUrl;

  InternationalNoticeScraper() {
    baseUrl = dotenv.get('INTERNATIONAL_URL');
    queryUrl = dotenv.get('INTERNATIONAL_QUERY_URL');
  }
