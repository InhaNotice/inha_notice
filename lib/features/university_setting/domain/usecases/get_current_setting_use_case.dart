...
class GetCurrentSettingUseCase {
  final UniversitySettingRepository repository;

  GetCurrentSettingUseCase({required this.repository});

  Future<Either<UniversitySettingFailure, String?>> call(
      {required String prefKey}) async {
    return await repository.getCurrentSetting(prefKey);
  }
}
