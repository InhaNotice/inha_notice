...
class ResetTodayFortuneTapCountUseCase {
  final TodayFortuneRepository repository;

  ResetTodayFortuneTapCountUseCase({required this.repository});

  Future<Either<TodayFortuneFailure, void>> call() {
    return repository.resetVersionTapCount();
  }
}
