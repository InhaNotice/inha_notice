...
class GetSelectedTabsUseCase {
  final CustomTabRepository repository;

  GetSelectedTabsUseCase({required this.repository});

  Future<Either<CustomTabFailure, List<String>>> call() async {
    return await repository.getSelectedTabs();
  }
}
