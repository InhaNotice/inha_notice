...
class NoticeBoardPreferenceTile extends StatelessWidget {
  final NoticeBoardDefaultType currentType;

  const NoticeBoardPreferenceTile({
    super.key,
  ...
  void _showSelectionDialog(BuildContext context) {
    showPlatformSelectionDialog<NoticeBoardDefaultType>(
      context: context,
      options: NoticeBoardDefaultType.values,
